...
class SignupVillageHeadPage extends StatefulWidget {
  ...
  @override
  State<SignupVillageHeadPage> createState() => _SignupVillageHeadPageState();
}
...
class _SignupVillageHeadPageState extends State<SignupVillageHeadPage> {
  ...
  Future<void> registerVillageHead() async {
    ...
    if (usernameController.text.isEmpty ||
      ...
      showSnack("กรุณากรอกข้อมูลให้ครบถ้วน");
      return;
    }

    setState(() => isLoading = true);

    final uri = Uri.parse("http://localhost/flutter_fire/register_village.php");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('สมัครสมาชิก - ผู้ใหญ่บ้าน'),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isLoading ? null : registerVillageHead,
